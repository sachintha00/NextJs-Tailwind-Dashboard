...
function DashboardItem() {
  return (
    <div>
      <div className="relative hidden text-gray-600 dropdown sm:block">
        <button
          type="button"
          className="btn border-0 h-[70px] text-xl px-3 dropdown-toggle dark:text-gray-100"
        ...
        <div
          className="absolute z-50 hidden list-none bg-white border rounded shadow dropdown-menu ltr:!right-0 ltr:!left-auto rtl:!left-0 rtl:!right-auto w-72 border-gray-50 dark:bg-zinc-700 dark:border-zinc-600 dark:text-gray-300"
          aria-labelledby="dropdownMenuButton1"
        >
          <div className="p-2">
            <div className="grid grid-cols-3">
              <a
                className="py-4 text-center dropdown-item hover:bg-gray-50/50 dark:hover:bg-zinc-700/50 dark:hover:text-gray-50"
                href="#"
              >
                <img
